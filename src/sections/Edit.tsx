...
const Edit = () => {
  ...
  return (
    <section
      ref={sectionRef}
      id="lookbook"
      className="relative w-screen h-screen bg-parchment overflow-hidden z-50"
      data-settle="0.50"
    >
      {/* Main Portrait Card */}
      <div
      ...
      >
        <img
          src="/images/edit-angled-top.jpg"
          alt="Fashion detail"
      ...
      >
        <img
          src="/images/edit-angled-bottom.jpg"
          alt="Atelier detail"
          className="w-full h-full object-cover"
        />
      </div>
      ...
      >
        <p className="text-parchment/90 text-sm md:text-base leading-relaxed">
          "A curated selection of luxury ready-to-wear pieces. Designed for the moments that matter, combining everyday elegance with our signature bespoke finishing."
        </p>
      </div>
    </section>
  );
